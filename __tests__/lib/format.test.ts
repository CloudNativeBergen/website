...
describe('formatOrgNumber', () => {
  it('should format a raw 9-digit string', () => {
    expect(formatOrgNumber('933338622')).toBe('933 338 622')
  })

  it('should leave already-formatted numbers unchanged', () => {
    expect(formatOrgNumber('933 338 622')).toBe('933 338 622')
  })

  it('should handle NO prefix', () => {
    expect(formatOrgNumber('NO933338622')).toBe('NO 933 338 622')
    expect(formatOrgNumber('NO 933338622')).toBe('NO 933 338 622')
  })

  it('should handle MVA suffix', () => {
    expect(formatOrgNumber('933338622MVA')).toBe('933 338 622 MVA')
    expect(formatOrgNumber('933338622 MVA')).toBe('933 338 622 MVA')
  })

  it('should handle NO prefix and MVA suffix together', () => {
    expect(formatOrgNumber('NO933338622MVA')).toBe('NO 933 338 622 MVA')
    expect(formatOrgNumber('NO 933338622 MVA')).toBe('NO 933 338 622 MVA')
    expect(formatOrgNumber('NO 933 338 622 MVA')).toBe('NO 933 338 622 MVA')
  })
