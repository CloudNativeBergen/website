    ...
    case 'www.bsky.app':
      return (
        <>
          ...
          <BlueskyIcon className={className} fill="currentColor" />
        </>
      )
    case 'instagram.com':
...
export function BlueskyIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path d="M6.43 4.76c2.16 1.63 4.52 4.95 5.57 6.72 1.05-1.77 3.41-5.09 5.57-6.72 1.56-1.17 4.03-2.06 4.03 0.79 0 0.58-0.33 4.84-0.52 5.54-0.67 2.4-3.13 3.02-5.31 2.65 3.82 0.65 4.78 2.8 2.69 4.96-3.98 4.09-5.73-1.03-6.18-2.34-0.08-0.24-0.12-0.35-0.12-0.26 0-0.1-0.04 0.02-0.12 0.26-0.45 1.31-2.2 6.43-6.18 2.34-2.09-2.16-1.13-4.31 2.69-4.96-2.18 0.37-4.64-0.25-5.31-2.65-0.19-0.7-0.52-4.96-0.52-5.54 0-2.85 2.47-1.96 4.03-0.79z" fill="currentColor"/>
    </svg>
  )
}
