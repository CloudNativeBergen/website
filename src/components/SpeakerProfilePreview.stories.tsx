...
/**
 * Organizer-only: the speaker-ticket status line, as `/admin/speakers` renders
 * it. Callers outside admin omit `ticketStatus` and the line disappears.
 */
export const WithTicketInvitedNotClaimed: Story = {
  args: {
    isOpen: true,
    onClose: fn(),
    speaker: mockSpeaker,
...
export const WithTicketClaimed: Story = {
  args: {
    isOpen: true,
    onClose: fn(),
    speaker: mockSpeaker,
    talks: mockTalks,
    ticketStatus: { speakerId: mockSpeaker._id, state: 'redeemed' },
  },
}

export const WithTicketNotInvited: Story = {
  args: {
    isOpen: true,
    onClose: fn(),
    speaker: mockSpeaker,
    talks: mockTalks,
    ticketStatus: { speakerId: mockSpeaker._id, state: 'not-invited' },
  },
}

export const WithTicketUnknown: Story = {
  args: {
    isOpen: true,
    onClose: fn(),
    speaker: mockSpeaker,
    talks: mockTalks,
    ticketStatus: { speakerId: mockSpeaker._id, state: 'unknown' },
  },
}
