      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <DialogPanel className="flex max-h-[90vh] w-full max-w-5xl transform flex-col overflow-hidden rounded-2xl bg-brand-glacier-white text-left align-middle shadow-2xl transition-all dark:bg-gray-900">
