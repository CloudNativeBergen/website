...
export function ProposalFilters({
  ...
  const activeCount = 
    ...
    (filters.showPartiallyScheduled ? 1 : 0)
  ...
  return (
    <AdminFilterBar
      ...
      sheetExtra={
        <div className="mt-4 border-t border-gray-100 pt-4 dark:border-gray-800 flex items-center space-x-2 px-1">
          <input
            type="checkbox"
            id="showPartiallyScheduled"
            checked={filters.showPartiallyScheduled}
            onChange={(e) => filters.setShowPartiallyScheduled(e.target.checked)}
      ...
      desktopExtra={
        <div className="flex items-center space-x-1.5 px-2">
          ...
          <label
            ...
            className="text-xs text-gray-600 dark:text-gray-400 cursor-pointer select-none whitespace-nowrap"
