  ...
  return (
    <div className="space-y-6">
          ...
          <div className="mt-3 rounded-md bg-blue-50 p-4 dark:bg-blue-900/30">
            <div className="text-sm text-blue-700 dark:text-blue-300">
              ...
              <ul className="mt-2 list-inside list-disc space-y-1">
                ...
                <li>
                  Recipients cannot access verification links from other devices
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            <div className="p-1.5">
              ...
              <div className="mt-2 px-2 py-1 text-xs text-gray-500 dark:text-gray-400">
                {badgeType === 'speaker' ? (
                  <span>
                    Issue badges to speakers with accepted or confirmed talks
                  </span>
                ) : (
      ...
      <div className="text-sm text-gray-500 dark:text-gray-400">
        Showing {eligibleSpeakers.length} of {eligibleSpeakers.length} speakers
      </div>
                  ...
                  <div className="max-h-[calc(90vh-200px)] overflow-y-auto">
                    <div className="bg-brand-mist/50 mb-6 rounded-lg p-4 dark:bg-gray-800/50">
                      <p className="text-sm text-brand-slate-gray dark:text-gray-400">
                        This preview shows how the badge will look. You can use
                        this to adjust the design in{' '}
