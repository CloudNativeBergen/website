 ...
 * Reconciled for rendering, filtering and the checkbox state once the plan has
 * loaded. The stale value stays in the URL — harmless, and rewriting it would
 * fight the back button — but nothing downstream sees it. `'me'` is a
