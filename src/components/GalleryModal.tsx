      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center">
            ...
            >
              <Dialog.Panel className="relative h-screen w-screen bg-black" onKeyDown={handleKeyDownReact}>
                <div className="flex h-full flex-col">
                  <div className="flex items-center justify-between border-b border-gray-800 bg-black/50 px-4 py-3 backdrop-blur-sm sm:px-6">
                    ...
                    <button
                      type="button"
                      className="rounded-md p-2 text-gray-400 hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
                      onClick={onClose}
                    >
                      ...
                      {currentImage?.imageUrl && (
                        <div className="relative h-full w-full">
                          <Image
                            ...
                            sizes="100vw"
                            priority={isOpen && currentIndex === 0}
                          />
                        </div>
                      )}
                      ...
                      {images.length > 1 && (
                        <>
                          <button
                            ...
                            className={cn(
                              'absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-3',
                          ...
                          <button
                            onClick={goToNext}
                            className={cn(
                              'absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-3',
                              'text-white backdrop-blur-sm transition-all hover:bg-black/70',
                              'focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-black'
                            )}
