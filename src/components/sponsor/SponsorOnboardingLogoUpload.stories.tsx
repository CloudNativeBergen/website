...
import { SponsorOnboardingLogoUpload } from './SponsorOnboardingLogoUpload'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Logo upload component for the sponsor onboarding portal. Supports primary and bright (dark-background) SVG logo variants with preview, download, and replace functionality.',
      },
    },
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof SponsorOnboardingLogoUpload>
