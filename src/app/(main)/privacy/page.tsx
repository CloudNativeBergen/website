...
export default async function PrivacyPolicyPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 print:max-w-none print:px-0 print:py-4">
      <div className="space-y-8 print:space-y-6">
        {/* Header */}
        <div className="text-center print:mb-4 print:text-left">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/20 print:hidden">
            <ShieldCheckIcon className="h-8 w-8 text-blue-600 dark:text-blue-400" />
          </div>
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white print:mb-2 print:text-3xl print:text-black">
            Privacy Policy
          </h1>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 print:mt-1 print:text-base print:text-black">
            Your privacy and data protection rights
          </p>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-500 print:mt-1 print:text-black">
            <strong>Last updated:</strong> {lastUpdated}
          </p>
        </div>

        {/* Quick Summary */}
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20 print:border-gray-300 print:bg-white print:p-4">
          <div className="flex items-start space-x-3 print:space-x-2">
            <InformationCircleIcon className="mt-1 h-5 w-5 flex-shrink-0 text-blue-600 dark:text-blue-400 print:hidden" />
            <div>
              <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200 print:text-base print:font-bold print:text-black">
                Quick Summary
              </h3>
              <p className="mt-1 text-sm text-blue-700 dark:text-blue-300 print:text-base print:text-black">
                We collect your information to organize the conference and
                manage speaker applications. We use privacy-friendly,
                cookie-less analytics to improve the website. We do not sell
                your data.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-6 print:break-before-page print:space-y-4">
          <div className="flex items-center space-x-3 print:space-x-0">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white print:text-xl print:text-black">
              1. Who We Are
            </h2>
          </div>
          ...
          <div className="space-y-4 print:space-y-3">
            <p className="text-base leading-7 text-gray-700 dark:text-gray-300 print:leading-relaxed print:text-black">
              {organizationName} is a technology conference organizer based in
              Bergen, Norway. We organize events focused on cloud native
          ...
          <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <li>
                      • Optional diversity and inclusion details (special
                      category data, collected only with your explicit consent)
                    </li>
            ...
            <div className="rounded-lg border border-purple-200 bg-purple-50 p-6 dark:border-purple-800 dark:bg-purple-900/20">
              ...
              <ul className="space-y-2 text-sm text-purple-700 dark:text-purple-300">
                <li>
                  • <strong>Email Communications:</strong> Messages between
                  organizers and speakers
                </li>
                <li>
                  • <strong>Conference Updates:</strong> Information about
                  ...
                  <ul className="space-y-1 text-sm text-indigo-700 dark:text-indigo-300">
                    ...
                    <li>
                      ...
                      <span className="ml-1 text-indigo-600 dark:text-indigo-300">
                        (may include health data; collected with your explicit
                        consent and used only to accommodate your needs)
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center space-x-3">
            <ScaleIcon className="h-6 w-6 text-gray-600 dark:text-gray-400" />
          ...
          <div className="space-y-6">
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20">
              ...
              <ul className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                ...
                <li>• Attendee registration and venue access control</li>
                <li>
                  • Sharing participant lists with venue partners for security
            ...
            <div className="rounded-lg border border-green-200 bg-green-50 p-6 dark:border-green-800 dark:bg-green-900/20">
              ...
              <ul className="space-y-2 text-sm text-green-700 dark:text-green-300">
                ...
                <li>• Public profile information for conference materials</li>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20">
              ...
              <p className="text-sm text-green-700 dark:text-green-300">
                Sending updates about the conference, speaking arrangements, and
                travel
              </p>
            </div>
            ...
            <div className="rounded-lg border border-teal-200 bg-teal-50 p-4 dark:border-teal-800 dark:bg-teal-900/20">
              ...
              <p className="text-sm text-teal-700 dark:text-teal-300">
                Registration management, access control, and sharing participant
                lists with venue partners for security
              </p>
            </div>
            ...
            <div className="rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-900/20">
              ...
              <p className="text-sm text-purple-700 dark:text-purple-300">
                Displaying speaker profiles and bios on the conference website
                (with consent)
              </p>
            </div>
            ...
            <div className="rounded-lg border border-pink-200 bg-pink-50 p-4 dark:border-pink-800 dark:bg-pink-900/20">
              ...
              <p className="text-sm text-pink-700 dark:text-pink-300">
                Privacy-friendly, cookie-less analytics to understand site usage
                (no advertising)
              </p>
            </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Content management and database services (EU-based, GDPR
                        compliant)
                      </p>
                    </div>
                  </div>
                ...
                <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800/50">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Website hosting, infrastructure, content delivery
                        network, and privacy-friendly analytics (Vercel
                        Analytics & Speed Insights; cookie-less)
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800/50">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Internal organizer notifications for operations (e.g.,
                        speaker proposal updates)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                  ...
                  <div className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                    <p>
                      • <strong>Participant registration lists</strong> - Names
                      and basic contact information shared for venue access
                      control and security
                    </p>
                    <p>
                      • <strong>Speaker information</strong> - Names and session
                      details for event coordination and technical setup
                    </p>
                    <p>
                      • <strong>Logistics coordination</strong> - Information
                      necessary for event management and facility access
                    </p>
                  </div>
                  <div className="mt-3 rounded-lg bg-blue-100 p-2 dark:bg-blue-800/30">
                    <p className="text-xs text-blue-800 dark:text-blue-200">
                      ...
                      event security, access control, and venue management. Data
                      sharing limited to information necessary for venue
                      operations.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="rounded-lg bg-yellow-50 p-3 dark:bg-yellow-900/20">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      • <strong>Sponsors for networking opportunities</strong>{' '}
                      (only if you opt in during registration)
                    </p>
                  </div>
                  <div className="rounded-lg bg-yellow-50 p-3 dark:bg-yellow-900/20">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      • <strong>Photography/videography vendors</strong> for
                      event documentation (with prior notice)
                    </p>
                  </div>
                  <div className="rounded-lg bg-yellow-50 p-3 dark:bg-yellow-900/20">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                      • <strong>Catering and hospitality providers</strong> for
                      dietary requirements and service coordination
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-base leading-7 text-gray-700 dark:text-gray-300">
              Some of our service providers may be located outside the EU/EEA.
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Some providers (e.g., Vercel, Slack, Resend) may process data in
              the United States. We rely on Standard Contractual Clauses and
              other safeguards required by GDPR for such transfers.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-800">
                    <th className="border-b border-gray-200 px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase dark:border-gray-700 dark:text-gray-400">
                      Data Type
                    </th>
                    <th className="border-b border-gray-200 px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase dark:border-gray-700 dark:text-gray-400">
                      Retention Period
                ...
                <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                  ...
                  <tr className="bg-blue-50 dark:bg-blue-900/20">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      Historical documentation of technology community events
                      and speakers.
                      <span className="font-medium text-blue-600 dark:text-blue-400">
                        Legitimate Interest:
                      </span>{' '}
                      Maintaining public archives of past conferences for
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      Conference documentation and operational continuity
                    </td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      ...
                      Event management, security, future event planning, and
            ...
            <div className="my-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                We maintain archived versions of conference programs with
                speaker information for historical and community purposes. This
                information was previously published with consent and serves the
                public interest of documenting our technology community&rsquo;s
                history. You can request removal of your information from
                archives at any time by contacting us.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-sm">
                Correct any inaccurate or incomplete personal data we have about
                you.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-sm">
                Limit how we use your personal data in certain situations while
                keeping it stored.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-sm">
                Receive your personal data in a machine-readable format to
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-sm">
                ...
                marketing purposes. This includes the right to object to
                analytics based on our legitimate interests.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-800 dark:bg-orange-900/20">
            ...
            <p className="text-sm text-orange-700 dark:text-orange-300">
              Where we process your data based on consent, you can withdraw that
              consent at any time. This won&rsquo;t affect the lawfulness of
          ...
          <div className="my-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20">
            ...
            <p className="text-sm text-green-700 dark:text-green-300">
              ...
              and may request identity verification for security purposes.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20">
              ...
              <p className="text-sm text-green-700 dark:text-green-300">
                All data is encrypted in transit (HTTPS/TLS) and at rest using
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                Role-based access controls with organizer-only admin functions
            ...
            <div className="rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-900/20">
              ...
              <p className="text-sm text-purple-700 dark:text-purple-300">
                Secure OAuth-based authentication through trusted providers
                (GitHub, LinkedIn).
              </p>
            </div>
            ...
            <div className="rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-800 dark:bg-orange-900/20">
              ...
              <p className="text-sm text-orange-700 dark:text-orange-300">
                Continuous security patches, system updates, and vulnerability
                monitoring.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-teal-200 bg-teal-50 p-4 dark:border-teal-800 dark:bg-teal-900/20">
              ...
              <p className="text-sm text-teal-700 dark:text-teal-300">
                We only collect and process data that is necessary for our
                stated purposes.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-indigo-200 bg-indigo-50 p-4 dark:border-indigo-800 dark:bg-indigo-900/20">
              ...
              <p className="text-sm text-indigo-700 dark:text-indigo-300">
                Regular privacy and security training for all organizers and
                team members.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              advertising or cross-site tracking. Our analytics are cookie-less
              and aggregated.
            </p>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              <strong>localStorage:</strong> We use your browser’s localStorage
              to save personal bookmarks on your device. This isn’t sent to our
              servers.
            </p>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              <strong>Opt-out:</strong> You can object to analytics by
              contacting us or using tools that block analytics requests; we
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20">
            <p className="text-yellow-800 dark:text-yellow-200">
              <strong>Age Restriction:</strong> Our services are not intended
              for individuals under 13 years of age. We do not knowingly collect
              personal data from children under 13. If you become aware that a
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-start rounded-lg border border-orange-200 bg-orange-50 p-3 dark:border-orange-800 dark:bg-orange-900/20">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700 dark:text-orange-300">
                  For significant changes, we may request renewed consent where
                  required by law
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-800 dark:bg-blue-900/20">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    <strong>Subject line:</strong> Please include &ldquo;Privacy
                    Policy&rdquo; in your email subject
                  </p>
                </div>
                <div>
                  <p className="text-sm text-blue-700 dark:text-blue-300">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 print:text-base print:text-black">
          This privacy policy complies with the EU General Data Protection
          Regulation (GDPR) and Norwegian data protection laws.
        </p>
      </div>
    </div>
  )
