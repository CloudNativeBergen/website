        ...
        <div className="relative py-20 sm:pb-24 sm:pt-36">
          ...
          <Container className="relative">
            <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
              ...
              <div className="mt-8">
                <Button href="mailto:contact@cloudnativebergen.dev" variant="outline">
      ...
      <Container className="relative">
        <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
          <div className="flex items-center justify-between gap-4">
            <h1 className="font-display text-4xl font-bold tracking-tighter text-blue-600 dark:text-blue-400 sm:text-5xl lg:text-7xl">
              Workshop Signup
            </h1>
            <Button href="/api/auth/signout" variant="outline" className="shrink-0 whitespace-nowrap">
              Sign Out
            </Button>
          </div>
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                    <p>
                      ...
                      {new Date(conference.workshop_registration_start!).toLocaleString('en-US', {
                        dateStyle: 'full',
                        timeStyle: 'short',
                      })}
                    </p>
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                    <p>
                      ...
                      {new Date(conference.workshop_registration_end!).toLocaleString('en-US', {
                        dateStyle: 'full',
                        timeStyle: 'short',
                      })}
                    </p>
