      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mb-16">
          ...
          <p className="font-inter mb-6 text-gray-600 dark:text-gray-400">
            Stacked avatar display with hover animation. Hover to see them
            spread apart.
          </p>
          ...
          <div className="space-y-8 rounded-xl border border-gray-200 bg-gray-50 p-8 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div>
              <p className="mb-3 text-sm font-medium text-gray-500 dark:text-gray-400">
                All 5 speakers (maxVisible: 3, shows +2)
              </p>
              <SpeakerAvatars
...
/>`}
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              ...
              <code className="font-jetbrains block rounded bg-gray-50 p-2 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-300">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              <h3 className="font-space-grotesk mb-3 text-lg font-semibold text-brand-fresh-green">
                SpeakerShare
              </h3>
              <p className="font-inter mb-4 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
              <div className="mb-4 flex items-center justify-between">
                ...
                <code className="font-jetbrains rounded bg-white px-2 py-1 text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-300">
                  variant=&quot;default&quot;
                </code>
              </div>
              <p className="font-inter mb-4 text-sm text-gray-600 dark:text-gray-400">
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              <h3 className="font-space-grotesk mb-3 font-semibold text-brand-cloud-blue">
              ...
              <pre className="font-jetbrains overflow-x-auto rounded bg-gray-50 p-3 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-300">
                {`<SpeakerShare
  speaker={speaker}
...
/>`}
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              <h3 className="font-space-grotesk mb-3 font-semibold text-brand-fresh-green">
...
/>`}
          ...
          <div className="mt-6 rounded-xl border border-brand-cloud-blue/20 bg-brand-sky-mist p-6">
            <h4 className="font-space-grotesk mb-3 font-semibold text-brand-cloud-blue">
              QR Code Integration
            </h4>
            <ul className="font-inter grid gap-4 text-sm text-brand-slate-gray md:grid-cols-2">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
            <table className="font-inter w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                <tr>
                  <td className="font-jetbrains px-4 py-3 text-brand-cloud-blue">
                    speaker
                  </td>
