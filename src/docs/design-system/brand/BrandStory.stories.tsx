    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-5xl px-8 py-16">
        ...
        <section className="mb-16">
          ...
          <p className="mb-8 font-inter text-lg text-brand-slate-gray dark:text-gray-300">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-brand-fresh-green/20 bg-brand-fresh-green/10 p-6 dark:border-green-500/20 dark:bg-gray-800">
              ...
              <p className="font-inter text-brand-slate-gray dark:text-gray-300">
                Every design choice considers the developer experience and technical
                audience. We speak their language visually and verbally.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Design Principles */}
        <section className="mb-16">
          <h2 className="mb-8 font-space-grotesk text-3xl font-semibold text-brand-cloud-blue dark:text-blue-400">
            Design Principles
          </h2>
          <div className="grid gap-6 md:grid-cols-2">
        ...
        <section>
          ...
          <div className="rounded-xl bg-brand-sky-mist p-6 dark:bg-gray-800">
            <ul className="grid gap-4 font-inter text-brand-slate-gray md:grid-cols-2 dark:text-gray-300">
