      ...
      <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
              <div className="relative mb-4 flex h-32 items-center justify-center overflow-hidden rounded-lg bg-linear-to-br from-slate-900 to-blue-900">
                <span className="font-inter text-xs text-white/60">Dark pattern preview</span>
              </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
              <div className="relative mb-4 flex h-32 items-center justify-center overflow-hidden rounded-lg border-2 border-brand-frosted-steel bg-white">
                <span className="font-inter text-xs text-gray-400">Light pattern preview</span>
              </div>
              <h3 className="mb-2 font-space-grotesk font-semibold text-brand-slate-gray dark:text-white">
                Light Variant
              </h3>
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
              <div className="relative mb-4 flex h-32 items-center justify-center overflow-hidden rounded-lg bg-brand-gradient">
                <span className="font-inter text-xs text-white/60">Brand pattern preview</span>
              </div>
              <h3 className="mb-2 font-space-grotesk font-semibold text-brand-slate-gray dark:text-white">
                Brand Variant
              </h3>
        ...
        <section className="mb-16">
          ...
          <div className="rounded-xl border border-brand-cloud-blue/20 bg-brand-sky-mist p-6 dark:border-blue-500/20 dark:bg-gray-800">
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                <h3 className="mb-3 font-space-grotesk font-semibold text-brand-cloud-blue dark:text-blue-400">
                  Small Icons (Sharp Focus)
                </h3>
                <ul className="space-y-2 font-inter text-sm text-brand-slate-gray dark:text-gray-300">
              ...
              <div>
                <h3 className="mb-3 font-space-grotesk font-semibold text-brand-fresh-green dark:text-green-400">
              ...
              <div>
                <h3 className="mb-3 font-space-grotesk font-semibold text-brand-nordic-purple dark:text-purple-400">
        ...
        <section className="mb-16">
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                <h3 className="mb-3 font-space-grotesk text-sm font-semibold text-brand-slate-gray dark:text-white">
        ...
        <section className="mb-16">
          ...
          <p className="mb-6 font-inter text-gray-600 dark:text-gray-400">
            The CloudNativePattern component renders animated CNCF project icons.
            View the live pattern on the{' '}
            <a href="/branding#pattern-system" className="text-brand-cloud-blue hover:underline">
              branding page
            </a>.
          </p>
          ...
          <div className="mb-8 overflow-hidden rounded-xl">
            <div className="relative flex h-64 items-center justify-center bg-linear-to-br from-slate-900 via-blue-900 to-slate-800">
              <div className="text-center">
                ...
                <p className="mt-2 font-inter text-lg text-brand-frosted-steel">
                  Hero Section Example
                </p>
                <p className="mt-4 font-inter text-xs text-white/40">
