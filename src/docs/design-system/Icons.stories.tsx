      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mb-16">
          <div className="rounded-xl border border-brand-cloud-blue/20 bg-brand-sky-mist p-6 dark:border-blue-500/20 dark:bg-gray-800">
            <h2 className="font-space-grotesk mb-4 text-xl font-semibold text-brand-cloud-blue dark:text-blue-400">
              Why Heroicons?
            </h2>
            <ul className="font-inter grid gap-2 text-sm text-brand-slate-gray md:grid-cols-2 dark:text-gray-300">
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <IconCard
              name="CloudIcon"
              Icon={CloudIcon}
              usage="Cloud computing, infrastructure"
            />
            <IconCard
              name="ServerIcon"
              Icon={ServerIcon}
              usage="Server resources, compute"
            />
            <IconCard
              name="CubeIcon"
              Icon={CubeIcon}
              usage="Containers, packaging"
            />
            <IconCard
              name="CircleStackIcon"
              Icon={CircleStackIcon}
              usage="Databases, storage"
            />
            <IconCard
              name="GlobeAltIcon"
              Icon={GlobeAltIcon}
              usage="Global distribution, CDN"
            />
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <IconCard
              name="LinkIcon"
              Icon={LinkIcon}
              usage="Service mesh, connections"
            />
            <IconCard
              name="ArrowPathIcon"
              Icon={ArrowPathIcon}
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <IconCard
              name="UserGroupIcon"
              Icon={UserGroupIcon}
              usage="Attendees, community"
            />
            <IconCard
              name="CalendarIcon"
              Icon={CalendarIcon}
              usage="Schedule, events"
            />
            <IconCard
              name="TicketIcon"
              Icon={TicketIcon}
              usage="Tickets, registration"
            />
            <IconCard
              name="MicrophoneIcon"
              Icon={MicrophoneIcon}
              usage="Speakers, talks"
            />
            <IconCard
              name="VideoCameraIcon"
              Icon={VideoCameraIcon}
              usage="Recordings, live"
            />
            <IconCard
              name="BuildingOfficeIcon"
              Icon={BuildingOfficeIcon}
              usage="Sponsors, companies"
            />
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-wrap items-end gap-8 rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            <div className="text-center">
              ...
              <code className="font-jetbrains mt-2 block text-xs text-gray-500">
                h-4 w-4
              </code>
            </div>
            <div className="text-center">
