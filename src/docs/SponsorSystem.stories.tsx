    ...
    <div className="min-h-screen bg-white p-8 dark:bg-gray-900">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="font-inter mb-12 text-lg text-brand-slate-gray dark:text-gray-300">
          ...
          sponsorships, from initial prospecting through contract signing and
          onboarding.
        </p>
        ...
        <section className="mb-16">
          ...
          <p className="font-inter mb-4 text-brand-slate-gray dark:text-gray-300">
            ...
            sponsorship lifecycle. See <strong>Admin/Sponsors</strong> in
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border border-brand-cloud-blue/20 bg-brand-sky-mist p-6 dark:border-blue-500/20 dark:bg-gray-800">
              <h3 className="font-space-grotesk mb-3 text-xl font-semibold text-brand-cloud-blue dark:text-blue-400">
                Sponsor Management
              </h3>
            ...
            <div className="rounded-lg border border-brand-fresh-green/20 bg-brand-sky-mist p-6 dark:border-green-500/20 dark:bg-gray-800">
              <h3 className="font-space-grotesk mb-3 text-xl font-semibold text-brand-fresh-green dark:text-green-400">
                Sponsor CRM
              </h3>
              <p className="font-inter mb-4 text-sm text-brand-slate-gray dark:text-gray-300">
            ...
            <div className="rounded-lg border border-brand-frosted-steel bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="font-inter rounded bg-brand-sky-mist px-3 py-1 text-xs text-brand-cloud-blue dark:bg-blue-900/30 dark:text-blue-400">
                    Prospect
                  </span>
                  <span className="font-inter rounded bg-brand-sky-mist px-3 py-1 text-xs text-brand-cloud-blue dark:bg-blue-900/30 dark:text-blue-400">
                    Contacted
                  ...
                  <span className="font-inter rounded bg-brand-fresh-green/20 px-3 py-1 text-xs text-brand-fresh-green dark:bg-green-900/30 dark:text-green-400">
                    Closed Won
                  </span>
                  <span className="font-inter rounded bg-red-100 px-3 py-1 text-xs text-red-600 dark:bg-red-900/30 dark:text-red-400">
                    Closed Lost
                  </span>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="rounded-lg bg-brand-sky-mist p-6 dark:bg-gray-800">
            <div className="grid gap-6 md:grid-cols-3">
              <div>
                <h3 className="font-jetbrains mb-3 text-sm font-semibold text-brand-slate-gray dark:text-gray-200">
                  Frontend
                </h3>
                <ul className="font-inter space-y-1 text-xs text-brand-slate-gray dark:text-gray-400">
                  <li>• Next.js 15</li>
